...
class UserSettings(Base):
    ...
    reconciliation_interval_hours: Mapped[int] = mapped_column(Integer, default=12, nullable=False)
    reconciliation_lookback_days: Mapped[int] = mapped_column(Integer, default=7, nullable=False)
    admin_inactivity_threshold_minutes: Mapped[int] = mapped_column(Integer, default=10, nullable=False)
    trainer_expected_aht_minutes: Mapped[float] = mapped_column(Numeric(5, 2), default=60.00, nullable=False)
    trainer_max_aht_minutes: Mapped[float] = mapped_column(Numeric(5, 2), default=70.00, nullable=False)
    trainer_onboarding_minutes: Mapped[float] = mapped_column(Numeric(6, 2), default=120.00, nullable=False)
    reviewer_expected_aht_minutes: Mapped[float] = mapped_column(Numeric(5, 2), default=45.00, nullable=False)
    reviewer_max_aht_minutes: Mapped[float] = mapped_column(Numeric(5, 2), default=70.00, nullable=False)
