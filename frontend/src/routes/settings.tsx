...
export default function Settings() {
  ...
  return (
    <div class="max-w-4xl mx-auto space-y-8">
      ...
      {/* SECTION: Hubstaff Personal Access Token (PAT) Authentication */}
        ...
        <div class="flex items-center justify-between pb-4 border-b border-slate-800">
          <div>
            ...
            <p class="text-xs text-slate-400 mt-1">
              Enter your Hubstaff Personal Access Token to authenticate API requests. In single-user mode, submitting a valid PAT provisions your profile and locks the field.
            </p>
          </div>
